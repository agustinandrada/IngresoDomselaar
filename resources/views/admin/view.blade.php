                ...
                <div class="row" style="margin-bottom: 25px;text-align: left;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-start">
                                <div class="mb-3"><label class="form-label" for="username"><strong>Usuario
                                        ...
                                        placeholder="Tu usuario es tu DNI" name="user" value="{{ $user->user }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3"><label class="form-label"
                                ...
                                type="text" name="last_name" required="" value="{{ $user->last_name }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3"><label class="form-label" for="role"><strong>Rol</strong></label><input
                                class="form-control" type="text" name="role"
