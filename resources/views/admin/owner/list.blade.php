                ...
                <div class="card-header py-3">
                    <div class="row table-topper align-items-center">
                        <form action="{{ route('owner-list') }}" method="GET"
                            ...
                            <a href="{{ route('export-owners') }}" target="_blank" class="btn btn-success btn-sm"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center d-flex justify-content-center align-middle"
                                                ...
                                                <a class="btn btnMaterial btn-flat primary semicircle" role="button"
                                                    href="/estancias/view-owner/{{ $owner->id }}"><i
                                                ...
                                                <a class="btn btnMaterial btn-flat success semicircle" role="button"
                                                    ...
                                                    href="/estancias/edit-owner/{{ $owner->id }}" title="Editar"><i
                                                        class="fas fa-pen"></i></a>

                                                <form action="/estancias/delete-owner/{{ $owner->id }}"
                                                    method="POST" id="delete-form{{ $owner->id }}">
                                                    @csrf
                                                    <button
