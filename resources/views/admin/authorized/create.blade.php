    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid" style="margin-top: 42px;">
            <div class="card shadow mb-3">
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('store-authorized') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row" style="margin-bottom: 25px;text-align: left;">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="username"
                                        style="font-family: Montserrat, sans-serif;font-size: 13px;">
                                        <strong>PERSONA AUTORIZADA DE</strong>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3"><label class="form-label" for="username"
                                        style="font-family: Montserrat, sans-serif;font-size: 13px;">
                                        <strong>LOTE</strong></label>
                                    <input class="form-control" type="text" name="lot"
                                        value="{{ old('lot') }}" id="lot" required>
                                </div>
                            </div>
                            <div class="col-md-6">
