    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid">
            <h1
                ...
                Autorizados Permanentes</h1>
            <div class="card" id="TableSorterCard">
                <div class="card-header py-3">
                    <div class="row table-topper align-items-center">
                        <form action="{{ route('authorized-list') }}" method="GET"
                        ...
                        <div class="col-12 col-sm-7 col-md-6 text-end" style="margin: 0px;padding: 5px 15px;"><i
                                class="fa fa-plus-circle"></i><a href="{{ route('create-authorized') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center d-flex justify-content-center align-middle"
                                            ...
                                            <a class="btn btnMaterial btn-flat primary semicircle" role="button"
                                                href="/estancias/view-authorized/{{ $authorized->id }}"><i
                                            ...
                                            <a class="btn btnMaterial btn-flat success semicircle" role="button"
                                                ...
                                                href="/estancias/edit-authorized/{{ $authorized->id }}"
                                                title="Editar"><i class="fas fa-pen"></i></a>

                                            <form action="/estancias/delete-authorized/{{ $authorized->id }}"
                                                method="POST" id="delete-form{{ $authorized->id }}">
                                                @csrf
                                                <button
                                                    class="btn btnMaterial btn-flat accent btnNoBorders checkboxHover"
                                                    type="button" title="Eliminar"
                                                    onclick="deleteUser({{ $authorized->id }})"><i
        ...
        <div class="pagination justify-content-center">
            {{ $authorizeds->links('vendor.pagination.bootstrap-4') }}
        </div>
    </div>
